...
class RulesTests(unittest.TestCase):
    ...
    def test_core_dump(self):
        ...
        self.assertTrue(all([isinstance(item, str) for item in stream]))
        stream = "".join(stream)
