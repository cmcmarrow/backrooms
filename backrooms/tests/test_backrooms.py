...
class TestHallway(unittest.TestCase):
    ...
    def test_init_2(self):
        self.assertIsInstance(Hallway("territory", BackRoomsCord(y=4)), Hallway)
    ...
    def test_bad_init_cord_x(self):
        self.assertRaises(BackRoomsError, Hallway, cord=BackRoomsCord(45, 3))

    def test_repr(self):
        self.assertIsInstance(repr(Hallway("TerrITory", BackRoomsCord(y=44))), str)

    def test_hash(self):
        self.assertIsInstance(hash(Hallway("ITs", BackRoomsCord(y=-44))), int)

    def test_eq(self):
        self.assertFalse(Hallway() == Hallway(cord=BackRoomsCord(y=-100)))

    def test_eq_2(self):
        self.assertTrue(Hallway(cord=BackRoomsCord(y=110)) == Hallway(cord=BackRoomsCord(y=110)))

    def test_nq(self):
        self.assertTrue(Hallway() != Hallway(cord=BackRoomsCord(y=-100)))

    def test_nq_2(self):
        self.assertFalse(Hallway(cord=BackRoomsCord(y=110)) != Hallway(cord=BackRoomsCord(y=110)))

    def test_gt(self):
        self.assertTrue(Hallway() > Hallway(cord=BackRoomsCord(y=-100)))

    def test_gt_2(self):
        self.assertFalse(Hallway(cord=BackRoomsCord(y=110)) > Hallway(cord=BackRoomsCord(y=120)))

    def test_lt(self):
        self.assertFalse(Hallway() < Hallway(cord=BackRoomsCord(y=-100)))

    def test_lt_2(self):
        self.assertTrue(Hallway(cord=BackRoomsCord(y=110)) < Hallway(cord=BackRoomsCord(y=120)))

    def test_cord(self):
        self.assertEqual(Hallway("territory", BackRoomsCord(y=4)).cord, BackRoomsCord(y=4))

    def test_name(self):
        self.assertEqual(Hallway("territory", BackRoomsCord(y=4)).name, "territory")

    def test_name_none(self):
        self.assertIsNone(Hallway().name)

    def test_y(self):
        self.assertEqual(Hallway(None, BackRoomsCord(y=4)).y, 4)
...
class TestBackrooms(unittest.TestCase):
    ...
    def test_init_2(self):
        self.assertIsInstance(Backrooms("Name",
                                        {BackRoomsCord(4): "A"},
                                        [Hallway(cord=BackRoomsCord(y=4)),
                                         Hallway(cord=BackRoomsCord(y=-4)),
                                         Hallway(cord=BackRoomsCord(y=0))]), Backrooms)
    ...
    def test_bad_init_name(self):
        self.assertRaises(BackRoomsError,
                          ...
                          [Hallway(cord=BackRoomsCord(y=4)),
                           Hallway(cord=BackRoomsCord(y=-4)),
                           Hallway(cord=BackRoomsCord(y=0))])
    ...
    def test_hallways_order(self):
        backrooms = Backrooms("Name",
                              ...
                              [Hallway(cord=BackRoomsCord(y=4)),
                               Hallway(cord=BackRoomsCord(y=-4)),
                               Hallway(cord=BackRoomsCord(y=23)),
                               Hallway(cord=BackRoomsCord(y=-2300)),
                               Hallway(cord=BackRoomsCord(y=230))])

        hallways = backrooms.hallways
        last = None
        for hallway in hallways:
            if last is not None:
                self.assertLess(hallway.y, last)
            last = hallway.y
    ...
    def test_get_hallway(self):
        func = Hallway("FUNC", cord=BackRoomsCord(y=23))
        backrooms = Backrooms("Name",
                              {BackRoomsCord(4): "A"},
                              [Hallway("MAIN", BackRoomsCord(y=4)),
                               Hallway(cord=BackRoomsCord(y=-4)),
                               func,
                               Hallway(cord=BackRoomsCord(y=-2300)),
                               Hallway(cord=BackRoomsCord(y=230))])
    ...
    def test_get_hallway_none(self):
        backrooms = Backrooms("Name",
                              ...
                              [Hallway("MAIN", BackRoomsCord(y=4)),
                               Hallway(cord=BackRoomsCord(y=-4)),
                               Hallway("FUNC", cord=BackRoomsCord(y=23)),
                               Hallway(cord=BackRoomsCord(y=-2300)),
                               Hallway(cord=BackRoomsCord(y=230))])
    ...
    def test_get_higher_hallway(self):
        higher = Hallway(cord=BackRoomsCord(y=-4))
        func = Hallway("FUNC", cord=BackRoomsCord(y=-8))
        backrooms = Backrooms("Name",
                              {BackRoomsCord(4): "A"},
                              [Hallway("MAIN", BackRoomsCord(y=4)),
                               Hallway(cord=BackRoomsCord(y=-2300)),
    ...
    def test_get_higher_hallway_top(self):
        func = Hallway("FUNC", cord=BackRoomsCord(y=99999))
        backrooms = Backrooms("Name",
                              {BackRoomsCord(4): "A"},
                              [Hallway("MAIN", BackRoomsCord(y=4)),
                               Hallway(cord=BackRoomsCord(y=-2300)),
    ...
    def test_bad_get_higher_hallway_unidentified(self):
        backrooms = Backrooms("Name",
                              ...
                              [Hallway("MAIN", BackRoomsCord(y=4)),
                               Hallway(cord=BackRoomsCord(y=-2300)),
                               Hallway(cord=BackRoomsCord(y=230))])
        self.assertRaises(BackRoomsError, backrooms.get_higher_hallway, Hallway("mAIN", BackRoomsCord(y=4)))

    def test_get_lower_hallway(self):
        lower = Hallway(cord=BackRoomsCord(y=-9))
        func = Hallway("FUNC", cord=BackRoomsCord(y=-8))
        backrooms = Backrooms("Name",
                              {BackRoomsCord(4): "A"},
                              [Hallway("MAIN", BackRoomsCord(y=4)),
    ...
    def test_bad_get_lower_hallway_unidentified(self):
        backrooms = Backrooms("Name",
                              ...
                              [Hallway("MAIN", BackRoomsCord(y=4)),
                               Hallway(cord=BackRoomsCord(y=-2300)),
                               Hallway(cord=BackRoomsCord(y=230))])
        self.assertRaises(BackRoomsError, backrooms.get_lower_hallway, Hallway("mAIN", BackRoomsCord(y=4)))
